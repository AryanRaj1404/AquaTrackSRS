...
>
    ...
    >
            ...
            <div className="flex gap-5">
                ...
                <div>
                    ...
                    <h2 className="text-2xl font-bold text-slate-900">
                        ...
                        {alert.alertType === "ANOMALY_LEAK"
                            ? t("alertDetails.possibleLeak")
                            : t("alertDetails.highConsumption")}

                    </h2>

                    <p className="mt-1 text-sm text-slate-500">

                        {t("alertDetails.alertId")} #{alert.id}
                    ...
                    <div className="mt-4 flex flex-wrap gap-3">
                        ...
                        >
                            {alert.acknowledged
                                ? `✓ ${t("alertDetails.status.acknowledged")}`
                                : `● ${t("alertDetails.status.pending")}`}
                        </span>
                        ...
                        >
                            {alert.alertType === "ANOMALY_LEAK"
                                ? t("alertDetails.type.leak")
                                : t("alertDetails.type.consumption")}
                        </span>
        ...
        <div className="grid grid-cols-2 gap-5 p-7">
            ...
            <InfoCard
                icon={Building2}
                title={t("alertDetails.apartment")}
                value={alert.apartmentName}
            />

            <InfoCard
                icon={Home}
                title={t("alertDetails.household")}
                value={alert.householdName}
            />

            <InfoCard
                icon={Droplets}
                title={t("alertDetails.waterConsumption")}
            ...
            <InfoCard
                icon={CalendarDays}
                title={t("alertDetails.triggeredOn")}
                value={new Date(alert.triggeredOn).toLocaleDateString(
                    i18n.language,
                    {
                        day: "2-digit",
                        month: "short",
            ...
            <InfoCard
                icon={Clock3}
                title={t("alertDetails.createdAt")}
        ...
        <div className="px-7 pb-7">
            ...
            <div className="rounded-2xl border border-slate-200 bg-linear-to-r from-slate-50 to-slate-100 p-5 shadow-sm">
                ...
                <p className="leading-7 text-slate-600">
                    ...
                    {alert.alertType === "ANOMALY_LEAK"
                        ? t("alertDetails.messages.leak", {
                            consumed: alert.litersConsumed,
                            average: alert.householdAverage
                        })
                        : t("alertDetails.messages.threshold", {
                            consumed: alert.litersConsumed,
        ...
        <div className="flex items-center justify-end gap-3 border-t border-slate-200 p-6">
            ...
            {alert.acknowledged ? (
                ...
                >
                    ...
                    {t("alertDetails.alreadyAcknowledged")}
